...
const step2Schema = Yup.object().shape({
  ...
  conjuge: Yup.string().when("estadocivil", {
    is: "Casado",
    then: (schema) =>
      schema.required("Por favor, digite o nome do seu cônjuge."),
  ...
  qtdfilhos: Yup.string().when("filhos", {
    is: "Sim",
    then: (schema) =>
      schema.required("Por favor, selecione a quantidade de filhos."),
    otherwise: (schema) => schema.notRequired(),
  }),
  ...
  nomefilhoum: Yup.string().when(["filhos", "qtdfilhos"], {
    is: (filhos, qtdfilhos) => {
      return (
        filhos === "Sim" &&
        isValidNumber(qtdfilhos) &&
        parseInt(qtdfilhos) >= 1 &&
        parseInt(qtdfilhos) <= 4
      );
    },
    then: (schema) =>
      schema.required("Por favor, digite o nome do primeiro filho."),
    otherwise: (schema) => schema.notRequired(),
  }),
  ...
  idadefilhoum: Yup.string().when(["filhos", "qtdfilhos"], {
    ...
    then: (schema) =>
      schema.required("Por favor, digite a idade do primeiro filho."),
    otherwise: (schema) => schema.notRequired(),
  }),
  ...
  nomefilhodois: Yup.string().when(["filhos", "qtdfilhos"], {
    is: (filhos, qtdfilhos) => {
      return (
        filhos === "Sim" &&
        isValidNumber(qtdfilhos) &&
        parseInt(qtdfilhos) >= 2 &&
        parseInt(qtdfilhos) <= 4
      );
    },
    then: (schema) =>
      schema.required("Por favor, digite o nome do segundo filho."),
    otherwise: (schema) => schema.notRequired(),
  }),
  ...
  idadefilhodois: Yup.string().when(["filhos", "qtdfilhos"], {
    ...
    then: (schema) =>
      schema.required("Por favor, digite a idade do segundo filho."),
    otherwise: (schema) => schema.notRequired(),
  }),
  ...
  nomefilhotres: Yup.string().when(["filhos", "qtdfilhos"], {
    is: (filhos, qtdfilhos) => {
      return (
        filhos === "Sim" &&
        isValidNumber(qtdfilhos) &&
        parseInt(qtdfilhos) >= 3 &&
        parseInt(qtdfilhos) <= 4
      );
    },
    then: (schema) =>
      schema.required("Por favor, digite o nome do terceiro filho."),
    otherwise: (schema) => schema.notRequired(),
  }),
  ...
  idadefilhotres: Yup.string().when(["filhos", "qtdfilhos"], {
    ...
    then: (schema) =>
      schema.required("Por favor, digite a idade do terceiro filho."),
    otherwise: (schema) => schema.notRequired(),
  }),
  ...
  nomefilhoquatro: Yup.string().when(["filhos", "qtdfilhos"], {
    ...
    then: (schema) =>
      schema.required("Por favor, digite o nome do quarto filho."),
    otherwise: (schema) => schema.notRequired(),
  }),
  ...
  idadefilhoquatro: Yup.string().when(["filhos", "qtdfilhos"], {
    ...
    then: (schema) =>
      schema.required("Por favor, digite a idade do quarto filho."),
    otherwise: (schema) => schema.notRequired(),
  }),
  ...
  optionprimeirocasamento: Yup.string().when("estadocivil", {
    is: "Casado",
    then: (schema) =>
      schema.required("Por favor, selecione se é seu primeiro casamento."),
    otherwise: (schema) => schema.notRequired(),
  }),
  ...
  casamentocristao: Yup.string().when("estadocivil", {
    is: "Casado",
    then: (schema) =>
      schema.required("Por favor, selecione se casou em cerimônia cristã."),
    otherwise: (schema) => schema.notRequired(),
  }),
  ...
  parceironaigreja: Yup.string().when("estadocivil", {
    is: "Casado",
    then: (schema) =>
      schema.required("Por favor, selecione se seu cônjuge se tornará membro."),
    otherwise: (schema) => schema.notRequired(),
  }),
