  ...
  return (
    <div className="form-step">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="mb-4">
          ...
          <select
            ...
            {...register("estadocivil", {
              required: "Por favor, selecione seu estado civil.",
            })}
          >
          ...
          <div className="mb-4">
            ...
            <input
              ...
              {...register("conjuge", {
                required:
                  watchEstadoCivil === "Casado"
                    ? "Por favor, digite o nome do seu cônjuge."
                    : false,
              })}
            />
            {errors.conjuge && (
        ...
        <div className="mb-4">
          <label htmlFor="filhos" className="form-label">
            Possui Filhos
          </label>
          <select
            id="filhos"
            className="form-input w-full"
            {...register("filhos", {
              required: "Por favor, selecione se possui filhos.",
            })}
          >
            <option value="">Selecione</option>
        ...
        {watchFilhos === "Sim" && (
          <div className="mb-4">
            <label htmlFor="qtdfilhos" className="form-label">
            ...
            <select
              ...
              {...register("qtdfilhos", {
                required:
                  watchFilhos === "Sim"
                    ? "Por favor, selecione a quantidade de filhos."
                    : false,
              })}
            >
                  ...
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      {...register("nomefilhoum", {
                        required:
                          parseInt(watchQtdFilhos, 10) >= 1
                            ? "Por favor, digite o nome do primeiro filho."
                            : false,
                      })}
                    />
                    {errors.nomefilhoum && (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      {...register("idadefilhoum", {
                        required:
                          parseInt(watchQtdFilhos, 10) >= 1
                            ? "Por favor, digite a idade do primeiro filho."
                            : false,
                      })}
                    />
                    {errors.idadefilhoum && (
                      <p className="form-error">
                        {errors.idadefilhoum.message}
                      </p>
                    )}
                  </div>
                </div>
                  ...
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      {...register("nomefilhodois", {
                        required:
                          parseInt(watchQtdFilhos, 10) >= 2
                            ? "Por favor, digite o nome do segundo filho."
                            : false,
                      })}
                    />
                    {errors.nomefilhodois && (
                      <p className="form-error">
                        {errors.nomefilhodois.message}
                      </p>
                    )}
                  </div>
                  <div>
                    <label
                      htmlFor="idadefilhodois"
                      className="form-label text-white"
                    >
                      Idade
                    </label>
                    <input
                      ...
                      {...register("idadefilhodois", {
                        required:
                          parseInt(watchQtdFilhos, 10) >= 2
                            ? "Por favor, digite a idade do segundo filho."
                            : false,
                      })}
                    />
                    {errors.idadefilhodois && (
                      <p className="form-error">
                        {errors.idadefilhodois.message}
                      </p>
                    )}
                  </div>
                </div>
                  ...
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      {...register("nomefilhotres", {
                        required:
                          parseInt(watchQtdFilhos, 10) >= 3
                            ? "Por favor, digite o nome do terceiro filho."
                            : false,
                      })}
                    />
                    {errors.nomefilhotres && (
                      <p className="form-error">
                        {errors.nomefilhotres.message}
                      </p>
                    )}
                  </div>
                  <div>
                    <label
                      htmlFor="idadefilhotres"
                      className="form-label text-white"
                    >
                      Idade
                    </label>
                    <input
                      ...
                      {...register("idadefilhotres", {
                        required:
                          parseInt(watchQtdFilhos, 10) >= 3
                            ? "Por favor, digite a idade do terceiro filho."
                            : false,
                      })}
                    />
                    {errors.idadefilhotres && (
                      <p className="form-error">
                        {errors.idadefilhotres.message}
                      </p>
                    )}
                  </div>
                </div>
                  ...
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      {...register("nomefilhoquatro", {
                        required:
                          parseInt(watchQtdFilhos, 10) >= 4
                            ? "Por favor, digite o nome do quarto filho."
                            : false,
                      })}
                    />
                    {errors.nomefilhoquatro && (
                      <p className="form-error">
                        {errors.nomefilhoquatro.message}
                      </p>
                    )}
                  </div>
                  <div>
                    <label
                      htmlFor="idadefilhoquatro"
                      className="form-label text-white"
                    >
                      Idade
                    </label>
                    <input
                      ...
                      {...register("idadefilhoquatro", {
                        required:
                          parseInt(watchQtdFilhos, 10) >= 4
                            ? "Por favor, digite a idade do quarto filho."
                            : false,
                      })}
                    />
                    {errors.idadefilhoquatro && (
                      <p className="form-error">
                        {errors.idadefilhoquatro.message}
                      </p>
                    )}
                  </div>
                </div>
      ...
      {watchEstadoCivil === "Casado" && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="mb-4">
            <label htmlFor="optionprimeirocasamento" className="form-label">
              Primeiro Casamento?
            </label>
            <select
              ...
              {...register("optionprimeirocasamento", {
                required:
                  watchEstadoCivil === "Casado"
                    ? "Por favor, selecione se é seu primeiro casamento."
                    : false,
              })}
            >
              <option value="">Selecione</option>
          ...
          <div className="mb-4">
            <label htmlFor="casamentocristao" className="form-label">
              Casaram-se em cerimônia cristã?
            </label>
            <select
              id="casamentocristao"
              className="form-input w-full"
              {...register("casamentocristao", {
                required:
                  watchEstadoCivil === "Casado"
                    ? "Por favor, selecione se casou em cerimônia cristã."
                    : false,
              })}
            >
              <option value="">Selecione</option>
          ...
          <div className="mb-4">
            <label htmlFor="parceironaigreja" className="form-label">
            ...
            <select
              ...
              {...register("parceironaigreja", {
                required:
                  watchEstadoCivil === "Casado"
                    ? "Por favor, selecione se seu cônjuge se tornará membro."
                    : false,
              })}
            >
              <option value="">Selecione</option>
